...
app.config["MYSQL_PASSWORD"] = 'elidek2022'
app.config["MYSQL_DB"] = 'elidek_db'
app.config["MYSQL_HOST"] = 'localhost'
app.config["SECRET_KEY"] = 'secret1' ## secret key for sessions (signed cookies). Flask uses it to protect the contents of the user session against tampering.
app.config["WTF_CSRF_SECRET_KEY"] = 'secret2' ## token for csrf protection of forms.
