...
class SfieldForm(FlaskForm):
    sfield_name = StringField(label = "sfield_name", validators = [DataRequired(message = "sfield_name is a required field.")])

    submit = SubmitField("Create")

class Phone_NumbersForm(FlaskForm):
    phone_number = StringField(label = "phone_number", validators = [DataRequired(message = "phone_number is a required field.")])
...
class ExecutiveForm(FlaskForm):
    exec_name = StringField(label = "exec_name", validators = [DataRequired(message = "exec_name is a required field.")])

    submit = SubmitField("Create")

class DeliverablesForm(FlaskForm):
    proj_id = StringField(label = "Proj_id", validators = [DataRequired(message = "Proj_id is a required field.")])

    title = StringField(label = "Title", validators = [DataRequired(message = "Title is a required field.")])

    summary = StringField(label = "Summary", validators = [DataRequired(message = "Summary is a required field.")])

    delivery_date = StringField(label = "Delivery_date", validators = [DataRequired(message = "Delivey_date is a required field.")])

    submit = SubmitField("Create") 

class Belongs_to_fieldForm(FlaskForm):
    proj_id = StringField(label = "Proj_id", validators = [DataRequired(message = "Proj_id is a required field.")])

    sfield_id = StringField(label = "sfield_id", validators = [DataRequired(message = "sfield_id is a required field.")])
...
class Works_onForm(FlaskForm):
    ...
    res_id = StringField(label = "res_id", validators = [DataRequired(message = "res_id is a required field.")])
